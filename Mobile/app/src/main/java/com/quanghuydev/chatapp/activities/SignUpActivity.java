...
import com.quanghuydev.chatapp.databinding.ActivitySignUpBinding;
...
public class SignUpActivity extends AppCompatActivity {
    ...
    private void signUp() {
        ...
        database.collection(Contants.KEY_COLLECTION_USERS).add(user).addOnSuccessListener(documentReference -> {
            loading(false);
    ...
    private Boolean isValidSignUpDetail() {
        if (encodedImage == null) {
            ...
            showToast("password and confirm password must bt same");
            return false;
        } else {
            return true;
        }
